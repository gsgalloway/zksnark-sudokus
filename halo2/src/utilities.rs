//! Utility gadgets. Copied from https://github.com/privacy-scaling-explorations/halo2/blob/main/halo2_gadgets/src/utilities.rs
//! to bypass the halo2_gadgets package's dependency on an older version of the halo2_proofs package, which is not compatible
//! with the versions of halo2_proofs imported by halo2wrong and maingate
